<?php
    ...
    if ($dayMenu && !empty($dayMenu->foodItems)) {
        $foodItems = WP_Mor_Resto_Public::get_food_items_by_type($dayMenu->foodItems, 'dessert');
        $svgContent = file_get_contents(WP_Mor_Resto_Public::get_asset_url('icons/icon-dessert.svg'));
